...
<div class="dash">
    <aside class="dash_sidebar">
        <article class="dash_sidebar_user">
            <img class="dash_sidebar_user_thumb" src="{{ auth()->user()->url_cover ?? url(asset("backend/assets/images/avatar.jpg")) }}" alt="" title=""/>
        ...
        <ul class="dash_sidebar_nav">
            ...
            <li class="dash_sidebar_nav_item"><a class="icon-sign-out on_mobile" href="{{ route('admin.logout') }}" target="_self">Sair</a></li>
        </ul>

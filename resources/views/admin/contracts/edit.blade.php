                                            ...
                                            <select class="select2" name="owner_id"
                                                ...
                                                @foreach($lessors as $lessor)
                                                    <option 
                                                        ...
                                                        value="{{ $lessor->id }}" {{ (old('owner_id') == $lessor->id ? 'selected' : ($contract->owner_id == $lessor->id ? 'selected' : '')) }}>
                                            ...
                                            <select name="acquirer_id" class="select2"
                                                ...
                                                @foreach($lessees as $lessee)
                                                    <option 
                                                        ...
                                                        value="{{ $lessee->id }}" {{ (old('acquirer_id') == $lessee->id ? 'selected' : ($contract->acquirer_id == $lessee->id ? 'selected' : '')) }}>

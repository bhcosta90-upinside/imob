...
<head>
    ...
    <link rel="stylesheet" href="{{ asset(mix('frontend/assets/css/bootstrap_person.css'))  }}">
    <link rel="stylesheet" href="{{ asset(mix('frontend/assets/css/libs.css'))  }}">
    <link rel="stylesheet" href="{{ asset(mix('frontend/assets/css/app.css'))  }}">
...
<script src="{{ asset(mix('frontend/assets/js/jquery.js')) }}"></script>
<script src="{{ asset(mix('frontend/assets/js/bootstrap.bundle.js')) }}"></script>
<script src="{{ asset(mix('frontend/assets/js/ekko-lightbox.min.js')) }}"></script>
<script src="{{ asset(mix('frontend/assets/js/bootstrap-select.js')) }}"></script>
<script src="{{ asset(mix('frontend/assets/js/scripts.js')) }}"></script>
